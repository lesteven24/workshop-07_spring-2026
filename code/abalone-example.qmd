...
H~0~: **[pH does not affect abalone shell growth.]**  

H~A~: **[pH does affect abalone shell growth.]**
...
#created a new data frame called abalone_clean
abalone_clean <- abalone |> 
  #cleaned names in dataframe
  clean_names() |> 
  #selected for certain variables in abalone_clean 
...
**The missing value comes from a pair of tanks in which the pH sensor malfunctioned, so thee is no pH reading from those tanks.**  
